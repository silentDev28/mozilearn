...
<!-- Mirrored from codeminifier.com/learnup-1.1/learnup/my-order.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 24 Oct 2020 13:56:48 GMT -->
<head>
		<meta charset="utf-8" />
					...
					<nav id="navigation" class="navigation navigation-landscape">
						...
						<div class="nav-menus-wrapper" style="transition-property: none;">
							<ul class="nav-menu">
								...
								<li><a href="index.php">Home<span class=""></span></a>
...
<!--											</ul>-->
										...
										<li class="active"><a href="my-order.php"><i class="ti-shopping-cart"></i>My Order</a></li>
                                        ...
                                        <div class="dashboard_container_body">
                                            <div class="table-responsive">
                                                <table class="table">
                                                    ...
                                                    $fetch_enroll=$conn->query("SELECT * FROM enroll  WHERE email='$active_student' ORDER BY id DESC");
